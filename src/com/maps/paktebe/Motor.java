...
public class Motor extends ListFragment  {	
 private static final String TAG_TAMBALBAN = "motor";
 private static final String TAG_ID = "id_tb";
 private static final String TAG_NAMA = "nama_tb";
 private static final String TAG_ALAMAT = "alamat_tb";
 private static final String TAG_TELP = "telp_tb";
 private static final String TAG_LAT = "lat";
 private static final String TAG_LNG = "lng";
 private static final String TAG_JARAK= "jarak";
 private static final String TAG_DIST= "dist";
 private static final String url = "http://api.targetkerja.com/tambalban/motor.php";
 ...
 public class AmbilDataJSON extends AsyncTask<String, Integer, ArrayList<HashMap<String, String>>>{
	 Context ctx;
			...
			for (int i = 0; i < tambalban.length(); i++){
				...
				Collections.sort(listMotor, new Comparator<HashMap<String, String>>() {
					...
					public int compare(HashMap<String, String> o1,
						...
						return Double.compare(Double.parseDouble(o1.get(TAG_JARAK)), Double.parseDouble(o2.get(TAG_JARAK)));
					}					
				});							
			}			
